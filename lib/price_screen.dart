      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: <Widget>[
              CryptoCard(value: valueBTC, selectedCurrency: selectedCurrency, selectedCrypto: 'BTC'),
              CryptoCard(value: valueETH, selectedCurrency: selectedCurrency, selectedCrypto: 'ETH'),
              CryptoCard(value: valueLTC, selectedCurrency: selectedCurrency, selectedCrypto: 'LTC'),
            ],
          ),
          Container(
            height: 150.0,
...
class CryptoCard extends StatelessWidget {
   CryptoCard({@required this.value, @required this.selectedCurrency, @required this.selectedCrypto});
